...
namespace ProjectTracking_WebAPI.Migrations
{
    ...
    [Migration("20220703225439_AddedInititalMigration")]
    partial class AddedInititalMigration
    {
            ...
            modelBuilder.Entity("ProjectTracking_WebAPI.Models.ProjectTask", b =>
                {
                    ...
                    b.Property<int>("EmployeeEmoloyeeID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectTracking_WebAPI.Models.ProjectTask", b =>
                {
                    b.HasOne("ProjectTracking_WebAPI.Models.Employee", "Employee")
                        ...
                        .HasForeignKey("EmployeeEmoloyeeID")
